                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                ...
                                <div id="kt_ecommerce_report_sales_export_menu" class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="export-monthly-report" class="menu-link px-3" data-kt-ecommerce-export="excel">Export as EXCEL</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu-->
                            ...
                            <a href="{{ route('export-monthly-report') }}"
                            ...
                            <table id="kt_table_users" class="table align-middle table-row-dashed fs-6 gy-5">
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end pe-0">{{ number_format($brandGrossMargins[$brand->id], 2) }}$</td>
                                        <td class="text-end">{{ number_format($Percentages[$brand->id], 2) }}%</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
