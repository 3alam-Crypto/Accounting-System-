...
<div class="container-fluid px-4">
    ...
    <div class="card mt-4">
        <div class="card-header">
            <h1 class="card-title">{{ __('Saleword.Edit Sale') }}</h1>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form action="{{ route('update-sale', ['sale' => $sale->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <label>{{ __('Saleword.Vendor Order ID') }}</label>
                        ...
                        <div class="mb-3 row">
                            <div class="col-md-6">
                                <label>{{ __('Saleword.Status') }}</label>
                ...
                <div class="card mt-4">
                    <div class="card-header">
                        <h2>{{ __('Saleword.Shipping Information') }}</h2>
                    </div>
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                ...
                <div class="card mt-4">
                    <div class="card-header">
                        <h2>{{ __('Saleword.Billing Information') }}</h2>
                    </div>
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
