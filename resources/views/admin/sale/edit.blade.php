            ...
            <form action="{{ route('update-sale', ['sale' => $sale->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            <select name="platform_id" id="platform" autocomplete="platform-name" class="small-select">
                        ...
                        <div class="mb-3">
                            <input class="small-select" type="date" name="shipping_date" class="form-control" id="shipping_date" value="{{ $sale->shipping_date }}">
                        </div>
                        ...
                        <div class="mb-3">
                            <input class="small-select" type="date" name="order_date" class="form-control" id="order_date" value="{{ $sale->order_date }}">
                        </div>
                        ...
                        <div class="mb-3">
                            <select name="brand_id" id="brand" autocomplete="brand-name" class="small-select">
                        ...
                        <div class="mb-3">
                            <select name="country_id" id="country" autocomplete="country-name" class="small-select">
